...
public interface ProductDocumentation {
	...
	ProductPort add(
		@ApiParam(value = "Product object which will be created.", required = true) ProductPort product
	);
	...
	ProductPort update(
		@ApiParam(value = "Product object which will be updated.", required = true) ProductPort product
	);
	...
	ProductPort update(
		...
		@ApiParam(value = "Product object changes to update.", required = true) ProductPort product
	);
