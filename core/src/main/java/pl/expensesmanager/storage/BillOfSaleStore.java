...
import pl.expensesmanager.domain.BillOfSaleApi;

import java.time.Instant;
import java.util.List;
import java.util.Optional;

public interface BillOfSaleStore extends BaseStorage<BillOfSaleApi, String> {
	 ...
	 */
	Optional<BillOfSaleApi> findByDescription(String description);
	 ...
	 */
	List<BillOfSaleApi> findByBoughtDate(Instant boughtDate);
	 ...
	 * @return found bills of sale list
	 */
	List<BillOfSaleApi> findByBoughtDateBetween(Instant min, Instant max);
