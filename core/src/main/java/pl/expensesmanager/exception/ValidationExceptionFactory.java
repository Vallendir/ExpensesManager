...
public final class ValidationExceptionFactory {
	...
	public static final class ErrorCode {
		...
		public static String TEXT_BLANK = "text.blank";
		
		public static String NUMBER_NULL = "number.null";
		
		public static String NUMBER_NAN = "number.nan";
		
		public static String DATE_NULL = "date.null";
		
		public static String PRODUCT_NAME = "product.name";
		
		public static String PRODUCT_PRICE = "product.price";
		
		public static String PRODUCT_QUANITY = "product.quanity";
		
		public static String PRODUCT_NULL = "product.null";
		
		public static String PRODUCT_ORDER_NULL = "product.order.null";
		
		public static String BILL_OF_SALE_DESCRIPTION = "bill.of.sale.description";
		
		public static String BILL_OF_SALE_NULL = "bill.of.sale.null";
		
		public static String BUDGET_NAME = "budget.name";
		
		public static String BUDGET_VALUE = "budget.value";
		
		public static String BUDGET_NULL = "budget.null";
	...
	public static final class ExceptionMessage {
		...
		public static String TEXT_BLANK = "Passed text cannot be blank.";
		
		public static String NUMBER_NULL = "Passed number value cannot be null.";
		
		public static String NUMBER_NAN = "Passed number value cannot be NAN.";
		
		public static String DATE_NULL = "Passed date cannot be null.";
		
		public static String PRODUCT_NAME = "Product name is invalid. Passed value is null or has wrong format.";
		
		public static String PRODUCT_PRICE = "Product price cannot be null or value is invalid.";
		
		public static String PRODUCT_QUANITY = "Product quanity cannot be null or value is invalid.";
		
		public static String PRODUCT_NULL = "Product cannot be null or is invalid.";
		
		public static String PRODUCT_ORDER_NULL = "Product order cannot be null or is invalid.";
		
		public static String BILL_OF_SALE_DESCRIPTION = "Description of bill of sale is invalid.";
		
		public static String BILL_OF_SALE_NULL = "Bill of sale cannot be null or is invalid.";
		
		public static String BUDGET_NAME = "Budget name is invalid. Passed value is null or has wrong format.";
		
		public static String BUDGET_VALUE = "Budget value cannot be null or value is invalid.";
		
		public static String BUDGET_NULL = "Budget cannot be null or is invalid.";
